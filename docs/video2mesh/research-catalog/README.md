...
| 物体 Mesh 补全 | [object-mesh-completion](object-mesh-completion/overview.md) | Hunyuan3D、Meshy、TRELLIS、NOVA3R、InstantMesh、Restore3D、image-blaster object jobs |
| 语义与 Scene Graph | [semantic-scene-graph](semantic-scene-graph/overview.md) | SAM/Grounded-SAM、Holi-Spatial、SceneVerse++ / PQ3D / SpatialLM、2D-to-3D fusion、semantic splats、face sidecar |
...
| 工业资产管线 | [industrial-pipelines](industrial-pipelines/overview.md) | SimFoundry、RoboSimGS、World Labs / Icare、image-blaster、Spark viewer、GLB runtime asset convention |
