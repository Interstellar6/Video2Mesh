...
category: 调研目录
updated: 2026-07-20
summary: 按刚体、软体、VLM 物理资产生成和 dynamic Gaussian 四条线整理物体交互、Feature Splatting、PhysX-Anything 与 Sim Anything / PhysSplat 的关系。
tags:
  - Research Catalog
  - Simulation
  - PhysX-Anything
...
| [Feature Splatting](#/doc/video2mesh-object-simulation-feature-splatting) | CLIP/DINOv2/SAM feature distillation、语言对象/部件选择、Gaussian 编辑与 Taichi MPM | 花瓶与花茎、植物、弹性体、颗粒动态 | P1 语言 feature/part selection，P2 dynamic Gaussian demo；不替代 mesh collider |
...
- P1/P2：Feature Splatting 先验证语言 feature 与现有 `object_id` 的一致性，再决定是否做 MPM 动态演示。
