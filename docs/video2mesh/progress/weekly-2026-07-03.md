...
![GS2Mesh 输出效果](assets/01-gs2mesh.png "GS2Mesh 输出保留床、窗帘和大结构，但墙面破碎、漂浮片和局部缺失仍明显")
...
![bedroom4 formal semantic mesh](assets/06-bedroom4-formal-semantic-mesh.png "新训练输出 bedroom4_formal_semantic_mesh_results_20260703 的语义 mesh，床、窗帘、墙面挂画/窗帘、地毯等主要区域已经能较清楚区分")
