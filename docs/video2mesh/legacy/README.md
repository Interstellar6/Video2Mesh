...
| [../research-catalog/README.md](../research-catalog/README.md) | 调研资料按流程阶段怎么找？ | 输入/位姿、3DGS、mesh、补全、语义、仿真和工业管线 |
| [../experiments/overview.md](../experiments/overview.md) | 本项目实验结果怎么找？ | GS2Mesh、Open3D Poisson、COLMAP Delaunay、语义回灌、object split 和 visual/physics proxy demo |
